#!/usr/bin/env python3
"""
Test script to verify OpenRouter API connectivity with the exact same configuration as the backend
"""
...
def test_cohere_connection():
    print("Testing Cohere API connection with backend configuration...")
    ...
    try:
        ...
        response = client.chat(message="Hello, are you working?", model=settings.cohere_model, max_tokens=20)
